    ...
    public class EmpleadosController : Controller
    {
       ...
       [HttpGet]
        public ActionResult Index(string nombre, string apellido, string departamento)
        {
            ...
            {
                int dep =Convert.ToInt32(departamento);
                
                var empleados = db.Empleados.Where(d => d.Departamento == dep);
                return View(empleados.ToList());
            }
            else if (nombre != "" && apellido == "" && departamento != "Ninguno")
            {
                int dep = Convert.ToInt32(departamento);
                var empleados = db.Empleados.Where(d => d.Departamento == dep && d.Nombre == nombre);
                return View(empleados.ToList());
            ...
            {
                int dep = Convert.ToInt32(departamento);
                var empleados = db.Empleados.Where(d => d.Departamento == dep && d.Apellido == apellido);
                return View(empleados.ToList());
